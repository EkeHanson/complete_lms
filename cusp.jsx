...
import { 
  ...
  DialogContent, DialogActions, TextField, MenuItem, Snackbar, Tooltip, Link,
  Chip, Autocomplete, Checkbox, FormControlLabel, FormGroup, Divider
} from '@mui/material';
import MuiAlert from '@mui/material/Alert';
import {Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, CalendarToday as CalendarIcon, Person as PersonIcon,
    Group as GroupIcon, Email as EmailIcon, Videocam as VideocamIcon, Groups as TeamsIcon
      ...
      <Box sx={{ 
        ...
        >
          <Table sx={{ minWidth: { xs: 650, md: 'auto' } }}>
            <TableHead>
              <TableRow>
                <TableCell sx={{ fontSize: { xs: '0.8rem', sm: '1rem' } }}>Title</TableCell>
                <TableCell sx={{ fontSize: { xs: '0.8rem', sm: '1rem' } }}>Type</TableCell>
                <TableCell sx={{ fontSize: { xs: '0.8rem', sm: '1rem' } }}>Date</TableCell>
                <TableCell sx={{ fontSize: { xs: '0.8rem', sm: '1rem' } }}>Time</TableCell>
                <TableCell sx={{ fontSize: { xs: '0.8rem', sm: '1rem' } }}>Location</TableCell>
                <TableCell sx={{ fontSize: { xs: '0.8rem', sm: '1rem' } }}>Invitees</TableCell>
            ...
            <TableBody>
              {events.map((event) => (
                <TableRow key={event.id}>
                  <TableCell sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{event.title}</TableCell>
                  <TableCell sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{event.type}</TableCell>
                  <TableCell sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{formatDate(event.date)}</TableCell>
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Box sx={{ 
                        ...
                        <GroupIcon sx={{ mr: 1, fontSize: { xs: '1rem', sm: '1.25rem' } }} />
                        {group.name}
                      </Box>
                    }
                  />
