...
import {
  ...
  Snackbar, Alert, Grid, Select, MenuItem
} from '@mui/material';
import { Search, Message, Add, Delete } from '@mui/icons-material';
      ...
      {selectedStudent && (
        <Dialog open={!!selectedStudent} onClose={() => setSelectedStudent(null)} fullWidth maxWidth="sm">
          ...
          <DialogActions>
            ...
            <Button variant="contained" startIcon={<Message />}>Send Message</Button>
          </DialogActions>
        </Dialog>
      )}
